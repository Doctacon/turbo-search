...
from turbo_search.config import RuntimeConfig, load_config
...
class AutoresearchExperiment:
    ...
    def plan_dict(self, *, out_dir: Path) -> dict[str, object]:
        return {
            ...
            "runner": "turbo_search.autoresearch",
            "one_shot": True,
            "config_only": True,
...
def run_experiment(experiment: AutoresearchExperiment, *, out_dir: Path) -> dict[str, object]:
    ...
    if experiment.mode == "fixture":
        ...
        from turbo_search.evals import run_live_evals
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m turbo_search.autoresearch",
