...
- `.10x/tickets/2026-07-19-return-retrieval-tags.md` is a bounded executable child with focused tests, full validation, documentation, evidence, review, no-live-operation, and explicit-exclusion requirements sufficient for cold-start implementation without widening into tag filtering or governance.
