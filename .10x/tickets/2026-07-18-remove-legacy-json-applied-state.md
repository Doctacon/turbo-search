...
- 2026-07-18: Opened PR #36; hosted Python 3.11, Python 3.13, and distribution-build checks passed in Actions run `29691090597`. Ticket remains active pending independent review.
