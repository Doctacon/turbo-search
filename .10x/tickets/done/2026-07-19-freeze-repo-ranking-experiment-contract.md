...
- `.10x/tickets/done/2026-07-20-remove-buoy-internal-ranking-judgment.md` owns the exact ratified future label removal and required rehash; it does not make Buoy sufficient because baseline approval/compatibility remains unresolved.
