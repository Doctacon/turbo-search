...
## Pre-existing unrelated broken references

These were captured before mutation and remained unchanged. Each target is split into its existing parent directory and absent filename so this evidence record does not itself create another broken reference:

- Source `.10x/evidence/2026-07-12-approved-apply-progress.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-approved-apply-progress.md`.
- Source `.10x/evidence/2026-07-12-approved-apply-throughput-measurement.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-approved-apply-throughput-measurement.md`.
- Source `.10x/evidence/2026-07-13-live-dagster-throughput-benchmark.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-live-dagster-throughput-benchmark.md`.
- Source `.10x/evidence/2026-07-13-readme-details-on-demand-rewrite.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-13-readme-details-on-demand-rewrite.md`.
- Source `.10x/evidence/2026-07-14-buoy-v0-2-0-release-attempt.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/evidence/2026-07-14-finalize-v0-2-1-release-docs.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-finalize-v0-2-1-release-docs.md`.
- Source `.10x/evidence/2026-07-14-publish-buoy-rebrand-commit.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/evidence/2026-07-15-bootstrap-protected-develop-branch.md:89`; target directory `.10x/tickets/`; absent filename `2026-07-15-add-pi-worktree-governance.md`.
- Source `.10x/evidence/2026-07-15-bootstrap-protected-develop-branch.md:90`; target directory `.10x/tickets/`; absent filename `2026-07-15-establish-protected-development-workflow.md`.
- Source `.10x/evidence/2026-07-15-bootstrap-protected-develop-branch.md:91`; target directory `.10x/tickets/`; absent filename `2026-07-15-integrate-pi-worktree-governance.md`.
- Source `.10x/reviews/2026-07-12-approved-apply-progress-review.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-approved-apply-progress.md`.
- Source `.10x/reviews/2026-07-12-approved-apply-throughput-measurement-review.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-approved-apply-throughput-measurement.md`.
- Source `.10x/reviews/2026-07-13-live-dagster-throughput-benchmark-review.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-12-live-dagster-throughput-benchmark.md`.
- Source `.10x/reviews/2026-07-14-readme-details-on-demand-review.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-13-readme-details-on-demand-rewrite.md`.
- Source `.10x/reviews/2026-07-18-thistle-provenance-reference-repair-review.md:18`; target directory `.10x/tickets/done/`; absent filename `2026-07-11-block-cross-host-crawl-redirects.md`.
- Source `.10x/specs/sitemap-resource-limits.md:41`; target directory `.10x/tickets/done/`; absent filename `2026-07-10-bound-sitemap-resource-usage.md`.
- Source `.10x/specs/sitemap-resource-limits.md:42`; target directory `.10x/evidence/`; absent filename `2026-07-10-sitemap-resource-limits.md`.
- Source `.10x/specs/sitemap-resource-limits.md:43`; target directory `.10x/reviews/`; absent filename `2026-07-10-sitemap-resource-limits-review.md`.
- Source `.10x/tickets/cancelled/2026-07-14-create-buoy-v0-2-0-github-release.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-add-buoy-ci-release-and-public-files.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-buoy-public-ci-release-plan.md:29`; target directory `.10x/tickets/`; absent filename `2026-07-14-finalize-v0-2-1-release-docs.md`.
- Source `.10x/tickets/done/2026-07-14-buoy-public-ci-release-plan.md:50`; target directory `.10x/tickets/`; absent filename `2026-07-14-finalize-v0-2-1-release-docs.md`.
- Source `.10x/tickets/done/2026-07-14-create-buoy-v0-2-1-github-release.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-finalize-v0-2-1-release-docs.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-publish-buoy-rebrand-commit.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-repair-release-workflow-and-bump-v0-2-1.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.
- Source `.10x/tickets/done/2026-07-14-validate-buoy-ci-release-automation.md:4`; target directory `.10x/tickets/`; absent filename `2026-07-14-buoy-public-ci-release-plan.md`.

Repairing these unrelated references is outside this ticket.

## What this supports or challenges

This supports the claim that only already-terminal records were relocated, affected references were repaired, historical record meaning was preserved, and no new graph breakage was introduced. It does not resolve or ratify the 27 unrelated pre-existing missing references.

## Limits

Independent record review is still required. This evidence does not close the owning ticket and does not claim that unrelated pre-existing reference debt is valid.
