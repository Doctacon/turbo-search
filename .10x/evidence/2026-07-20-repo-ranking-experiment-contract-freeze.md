...
The user's subsequent ratification to remove only the grade-1 internal Buoy `.10x` judgment is owned by `.10x/tickets/done/2026-07-20-remove-buoy-internal-ranking-judgment.md`. It did not alter this evidence, the dataset, the recorded 370-judgment count, or any hash during C1 closure, and it does not establish Buoy baseline sufficiency.
